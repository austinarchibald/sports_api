class SportsApi::Fetcher::Boxscore::CBASE < SportsApi::Fetcher::Boxscore
  ...
  def score_fetcher
    @score_fetcher ||= SportsApi::Fetcher::Score::CBASE.find(event_date)
  end

  def markup
    @markup ||= get('cbase/game', gameId: gameid)
  end
end
