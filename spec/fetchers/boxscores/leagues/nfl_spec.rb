...
#     before { expect_instance.to receive(:get).with('football', 'nfl', dates: 20150816).and_return(json_stub_week_1) }
#     before { expect_instance.to receive(:get).with('football', 'nfl', dates: 20150816).and_return(json_stub_week_2) }
