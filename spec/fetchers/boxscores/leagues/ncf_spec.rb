...
#     before { expect_instance.to receive(:get).with('football', 'college-football', dates: 20150904, limit: 300, groups: 80).and_return(json_stub_week_1) }
#     before { expect_instance.to receive(:get).with('football', 'college-football', dates: 20150904, limit: 300, groups: 80).and_return(json_stub_week_1) }
